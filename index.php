...
<head>
  ...
  <script>
    function javafun(){
      alert('Button Clcked');
      var searchval=document.getElementById("searchboxx");
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="menu-main-menu-container">
                  <ul id="top-menu" class="navbar-nav ml-auto">
                    ...
                    <li class="menu-item"><a href="/livetv.html">Live Tv</a></li>
                    <li class="menu-item"><a href="/movie.html">Movies</a></li>
                    <li class="menu-item"><a href="/series.html">Series</a></li>
                    <!-- <li class="menu-item">
                      <a href="#">Contact Us</a>
                      <ul class="sub-menu">
                          ...
                          <form action="#" id="myform"
                           class="searchbox">
                            <div class="form-group position-relative">
                              <input type="search" class="text search-input font-size-12" id="textbox"
                ...
                <ul class="d-flex align-items-center list-inline m-0">
                  <li class="nav-item nav-icon">
                    ...
                    <div class="search-box iq-search-bar d-search">
                      <form   action="searchsplitter.html" class="searchbox">
                        <div class="form-group position-relative">
                          <input type="text"  name="search"  id="searchboxx" class="text search-input font-size-12"
                            placeholder="type here to search..." />
                            <input type="submit">
                          <i class="search-link fa fa-search"></i>
                        </div>
